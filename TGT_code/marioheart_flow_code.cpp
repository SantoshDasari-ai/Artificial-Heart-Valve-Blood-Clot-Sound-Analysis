...
constexpr int STEPS = 622;    // Number of steps for equivalent of 140 degrees (based on microstepping at 1600 steps per revolution for a 1.8-degree stepper motor)
